...
public class TesteConsumerVirutalTopic1 implements MessageListener {
	
	@Override
	public void onMessage(Message message) {
		// TODO Auto-generated method stub
		try {
			System.out.println("TesteVirtualTopicA: Recebendo mensagem: " + ((TextMessage) message).getText());
			Thread.sleep(5000);
		} catch (Exception e) {
